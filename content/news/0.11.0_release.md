...
it finally crystalizes the effort to replace Raft with a system that allows
...
configuration and they automatically discover each other and form a Cluster.
